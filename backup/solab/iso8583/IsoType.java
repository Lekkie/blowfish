...
public enum IsoType {
	...
	LLLLBIN(false, 0),
	/** A variable length alphanumeric value with a 5-digit header length. */
	LLLLLVAR(false, 0), // Added by Lekan Omotayo
	/** A variable length alphanumeric value with a 6-digit header length. */
	LLLLLLVAR(false, 0), // Added by Lekan Omotayo
	...
	/** Formats a Date if the receiver is DATE12, DATE10, DATE4, DATE_EXP or TIME; throws an exception
	 * otherwise. */
	public String format(final Date value, final TimeZone tz) {
        final SimpleDateFormat sdf;
		if (this == DATE12) {// Added by Lekan Omotayo
	...
	public String format(String value, int length) {
		...
		} else if (this == LLVAR || this == LLLVAR || this == LLLLVAR || this == LLLLLVAR || this == LLLLLLVAR) { // Added by Lekan Omotayo
			return value;
		...
		} else if (this == LLBIN || this == LLLBIN || this == LLLLBIN) {// Added by Lekan Omotayo
			return value;
		}
	...
	public String format(long value, int length) {
		if (this == NUMERIC) {
	        ...
	        return x;
		} else if (this == ALPHA || this == LLVAR || this == LLLVAR || this == LLLLVAR || this == LLLLLVAR || this == LLLLLLVAR) { // Added by Lekan Omotayo
			return format(Long.toString(value), length);
		} else if (this == AMOUNT) {
			return String.format("%010d00", value);
		} else if (this == BINARY || this == LLBIN || this == LLLBIN || this == LLLLBIN)  { // Added by Lekan Omotayo
			//TODO
		}
