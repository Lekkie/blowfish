...
/*---------------------------------------------------------------------------*/
/**
 * This is a utility class that handles converstion between binary strings and hex strings
 *
 * @version 1
 *																			*/
/*---------------------------------------------------------------------------*/
 ...
 *	1		Babafemi	25/08/2003		MYB010000F			Created
 *
 *
 *	Last modified in: v1.0
\*---------------------------------------------------------------------------*/
...
public class HexConverter {
	...
	public static String fromBinary2Hex(byte[] binary_data, int len) {
		byte lo, hi;
