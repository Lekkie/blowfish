...
public class IsoValue<T> implements Cloneable {
	...
	public IsoValue(IsoType t, T value, CustomField<T> custom) {
		...
		type = t;
		this.value = value;
		if (type == IsoType.LLVAR || type == IsoType.LLLVAR || type == IsoType.LLLLVAR || type == IsoType.LLLLLVAR || type == IsoType.LLLLLLVAR) { // Modified by Lekan Omotayo
			if (custom == null) {
			...
			} else if (t == IsoType.LLLLLVAR && length > 99999) {// Modified by Lekan Omotayo
				throw new IllegalArgumentException("LLLLLVAR can only hold values up to 99999 chars");
			} else if (t == IsoType.LLLLLLVAR && length > 999999) {// Modified by Lekan Omotayo
	...
	public IsoValue(IsoType t, T val, int len, CustomField<T> custom) {
		...
		} else if (t == IsoType.LLVAR || t == IsoType.LLLVAR || t == IsoType.LLLLVAR || t == IsoType.LLLLLVAR || t == IsoType.LLLLLLVAR) { // Modified by Lekan Omotayo
			if (len == 0) {
	...
	public String toString() {
		...
		if (type == IsoType.NUMERIC || type == IsoType.AMOUNT) {
			...
			return type.format(encoder == null ? value.toString() : encoder.encodeField(value), length);
		} else if (type == IsoType.LLVAR || type == IsoType.LLLVAR || type == IsoType.LLLLVAR || type == IsoType.LLLLLVAR || type == IsoType.LLLLLLVAR) { // Modified by Lekan Omotayo
	...
	protected void writeLengthHeader(final int l, final OutputStream outs, final IsoType type,
		...
		if (binary) {
			if (digits == 6) {
				outs.write((((l % 1000000) / 100000) << 4) | ((l % 100000)/10000)); // 00000 to 99999-- // Added by Lekan Omotayo
				outs.write((((l % 10000) / 1000) << 4) | ((l % 1000)/100));
			} else if (digits == 5) {
				outs.write((((l % 10000) / 100) << 4) | ((l % 10000)/100)); // 0000 to 9999 -- // Added by Lekan Omotayo
				outs.write(l / 10000);
			} else if (digits == 4) {
				outs.write((((l % 10000) / 1000) << 4) | ((l % 1000)/100)); // 000 to 999
			} else if (digits == 3) {
			...
			if (digits == 6) { // Added by Lekan Omotayo
				// 123456 will be
				// (123456 / 100000) + 48 = 1 + 48 = 49
				// (123456 % 100000) / 10000) + 48 = (23456 / 10000) + 48 = 2 + 48 = 50
				// ((123456 / 1000) % 10) + 48 = (123 % 10) + 48 = 3 + 48 = 51
				// ((123456 % 1000) / 100) + 48 = (456 / 100) + 48 = 4 + 48 = 52
				// ((123456 % 100) / 10) + 48 = (45 / 10) + 48 = 5 + 48 = 53
				// (123456 % 10) + 48 = 6 + 48 = 54
				outs.write((l/100000)+48);
				outs.write(((l%100000)/10000)+48);
				outs.write(((l/1000)%10)+48);
				outs.write(((l%1000)/100)+48);

			} else if (digits == 5) { // Added by Lekan Omotayo
				// 12345 will be
				// (12345 / 10000) + 48 = 1 + 48 = 49
				// (12345 % 10000) / 1000) + 48 = (2345 / 1000) + 48 = 2 + 48 = 50
				// ((12345 / 100) % 10) + 48 = (123 % 10) + 48 = 3 + 48 = 51
				// ((12345 % 100) / 10) + 48 = (45 / 10) + 48 = 4 + 48 = 52
				// (12345 % 10) + 48 = 5 + 48 = 53
				...
				// 1234 will be
				// (1234 / 1000) + 48 = 1 + 48 = 49
				// ((1234 % 1000) / 100) + 48 = (234 /100) + 48 = 2 + 48 = 50
				// ((1234 % 100) / 10) + 48 = (34 / 10) + 48 = 3 + 48 = 51
				// (1234 % 10) + 48 = 4 + 48 = 56
				...
				// 123 will be
				// (123 / 100) + 48 = 1 + 48 = 49
				// ((123 % 100) / 10) + 48 = (23 / 10) + 48 = 2 + 48 = 50
				// (123 % 10) + 48 = 3 + 48 = 51
				outs.write((l / 100) + 48);
			}
			if (l >= 10) {
	...
	public void write(final OutputStream outs, final boolean binary, final boolean forceStringEncoding) throws IOException {
		if (type == IsoType.LLLVAR || type == IsoType.LLVAR || type == IsoType.LLLLVAR || type == IsoType.LLLLLVAR || type == IsoType.LLLLLLVAR) { // Modified by Lekan Omotayo
