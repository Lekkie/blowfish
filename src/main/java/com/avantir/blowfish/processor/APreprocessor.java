...
public abstract class APreprocessor implements IProcessor{
    ...
    public static void validateBase(String mid, String tid, String tranTypeCode, String pan, String expDate) throws Exception{
        ...
        Merchant terminalMerchant = merchantService.findByMerchantId(merchantTerminal.getMerchantId());
        ...
        AcquirerMerchant acquirerMerchant = acquirerMerchantService.findByMerchantId(terminalMerchant.getMerchantId());
        ...
        AcquirerMerchantTranTypeBin acquirerMerchantTranTypeBin = acquirerMerchantTranTypeBinService.findByAcquirerIdMerchantIdTranTypeIdBinId(acquirer.getAcquirerId(), terminalMerchant.getMerchantId(), tranType.getTranTypeId(), bin.getBinId());
        ...
        MerchantTerminalTranTypeBin merchantTerminalTranTypeBin = merchantTerminalTranTypeBinService.findByMerchantIdTerminalIdTranTypeIdBinId(terminalMerchant.getMerchantId(), terminal.getTerminalId(), tranType.getTranTypeId(), bin.getBinId());
