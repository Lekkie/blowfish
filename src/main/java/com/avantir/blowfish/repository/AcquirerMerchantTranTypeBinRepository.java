...
import com.avantir.blowfish.model.AcquirerMerchantTranTypeBin;
...
public interface AcquirerMerchantTranTypeBinRepository extends JpaRepository<AcquirerMerchantTranTypeBin, Long> {
    ...
    AcquirerMerchantTranTypeBin findByAcquirerMerchantTranTypeBinId(@Param("acquirerMerchantTranTypeBinId") Long acquirerMerchantTranTypeBinId);
    ...
    List<AcquirerMerchantTranTypeBin> findByTranTypeId(@Param("tranTypeId") Long tranTypeId);
    List<AcquirerMerchantTranTypeBin> findByBinId(@Param("binId") Long binId);
    ...
    AcquirerMerchantTranTypeBin findByAcquirerIdMerchantIdTranTypeIdBinId(@Param("acquirerId") Long acquirerId, @Param("merchantId") Long merchantId, @Param("tranTypeId") Long tranTypeId, @Param("binId") Long binId);
