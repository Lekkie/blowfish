...
public class Transaction extends BaseModel{
    ...
    @Column(name = "acquirer_inst_id", nullable = true)
    ...
    @Column(name = "pan_hash", nullable = true)
    String panHash;
    @Column(name = "pan_mask", nullable = true)
    String panMask;
    @Column(name = "pan_encrypted", nullable = true)
    String panEncrypted;

    @Column(name = "tran_type", nullable = true)
    String tranType;
    @Column(name = "src_acc_type", nullable = true)
    String srcAccType;
    @Column(name = "dest_acc_type", nullable = true)
    String destAccType;
    ...
    String posEntryMode;
    @Column(name = "cardSeqNr", nullable = true)
    String cardSeqNr;
    ...
    @Column(name = "ret_ref_nr", nullable = false)
    String retRefNr;
    ...
    @Column(name = "tran_currency", nullable = false)
    String tranCurrency;
    ...
    @Column(name = "algo_version", nullable = true)
