...
-- Merchants (test purpose)
INSERT INTO tbl_endpoints (ip, port, timeout, ssl_enabled, description, status, created_by, created_on) VALUES ('196.6.103.72', 5042, 60, false, 'NIBSS CTMS', 1, 'System', CURRENT_TIMESTAMP());
